...
public class BrowseSeriesController {
    ...
    public TvSeriesBean expandedDetails(String showName) {
        ...
        return new TvSeriesBean.Builder(tvSeries.getName(), tvSeries.getSeasons(), tvSeries.getImgSource(), tvSeries.getPlot(), tvSeries.getEpisodes(), tvSeries.getGenre(), tvSeries.getCountryOfOrigin()).rating(tvSeries.getRating()).airingDate(tvSeries.getAiringDate()).watchlistStatus(tvSeries.getAiringStatus()).build();
    }
}
